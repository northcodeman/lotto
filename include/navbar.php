        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="interLotto">
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นเกาหลี</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-นิเคอิรอบเช้า</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-นิเคอิรอบบ่าย</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-ฮั่งเส็งรอบเช้า</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-ฮั่งเส็งรอบบ่าย</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-จีนรอบเช้า</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-จีนรอบบ่าย</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นไต้หวัน</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นสิงคโปร์</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นอียิปต์</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นเยอรมัน</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นอังกฤษ</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นรัสเซีย</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นอินเดีย</a></li>
              <li><a class="dropdown-item font15 text-white" href="#projects">-หุ้นดาวโจนส์</a></li>
            ...
            <ul class="list-unstyled">
              <li class="nav-item">
                ...
                <div class="collapse" id="interLottoM">
                  <ul>
                    <li><a class="font15 text-white" href="#projects">-หุ้นเกาหลี</a></li>
                    <li><a class="font15 text-white" href="#projects">-นิเคอิรอบเช้า</a></li>
                    <li><a class="font15 text-white" href="#projects">-นิเคอิรอบบ่าย</a></li>
                    <li><a class="font15 text-white" href="#projects">-ฮั่งเส็งรอบเช้า</a></li>
                    <li><a class="font15 text-white" href="#projects">-ฮั่งเส็งรอบบ่าย</a></li>
                    <li><a class="font15 text-white" href="#projects">-จีนรอบเช้า</a></li>
                    <li><a class="font15 text-white" href="#projects">-จีนรอบบ่าย</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นไต้หวัน</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นสิงคโปร์</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นอียิปต์</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นเยอรมัน</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นอังกฤษ</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นรัสเซีย</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นอินเดีย</a></li>
                    <li><a class="font15 text-white" href="#projects">-หุ้นดาวโจนส์</a></li>
